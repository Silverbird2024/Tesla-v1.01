...
$scope.PushButton617_click = function() {$scope.GotoPage( "Home" );};
...
$scope.PushButton625_click = function() {$scope.GotoPrevPage();};
});
...
$scope.PushButton628_click = function() {$scope.GotoPage( "Home" );};
...
$scope.PushButton635_click = function() {$scope.GotoPrevPage();};
});
...
$scope.PushButton636_click = function() {$scope.GotoPage( "Home" );};
...
$scope.PushButton640_click = function() {$App.r15t = $scope.Calculate($App.r14t+"-1",-1);
...
$scope.PushButton643_click = function() {$scope.GotoPrevPage();};
});
