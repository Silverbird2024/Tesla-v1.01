...
$App.NAB={PageList:["Home","Home2","Q0001","WQ0001","KnowThyselfMoney","RetireMentPlanMain","RetireMentPlanMainEdit","Calc01","Calc02","Calc03","Calc04","Calc05","CentralAdmin","Mindmap","Disciplin","Versiondetail","startday","TheMeans","Filter","Health","FF","WDIW","KnowTyMoInput01","Work01","RulesMatter","WorkDayType001","Workday01","Workday02","Workday03","Workday04","Workday05","Workday06","Workday07","Workday08","Workdaytyperecordandnotes","ADHDhelper","Time-Pa","Rulz","WorkDoNotEnjoy01","WorkDoNotEnjoy02","WorkDoNotEnjoy03","WorkDoNotEnjoy04","WorkDoNotEnjoy05","WorkDoNotEnjoy06","WorkDoNotEnjoy07","WorkDoNotEnjoy08","WorkCWD-adjust","Dailysheet","adh00","adh01","adh02","adh03","adh04","adh05","adh06","adh07","adh08","adh09","adh10","adh11","adh12","adh13","adh14","adh15","adh16","RanMain","Dreamboard","Dreamboard01","Dreamboard02","Dreamboard03","Dreamboard04","Dreamboard05","Dreamboard06","Dreamboard07","Dreamboard08","Dreamboard09","Dreamboard10","Dreamboard11","Dreamboard12","Dreamboard13","Dreamboard14","Dreamboard15","Dreamboard16","Dreamboard17","Dreamboard18","Dreamboard19","Dreamboard20","Dreamboard21","Permanace","Page02","Milesrecorder","map","Random","Random01","Random02","Random03","Random04","Random05","Random06","Random07","Random08","Random09","Random10","Random11","Random12","Random13","Random14","Random15","Random16","Random17","Random18","Random19","Random20","Random21","Random22","Random23","Random24","Random25","Dictionary"],PageEnterEffect:["fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","","","","","","","","","","","","","","","","","","","","","","","","","","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn"],PageCount:119,_pageEffect:" animate fadeIn",PageExitEffect:["","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""],PageNumber:1,AppScale:1,PageID:"",Hour:"",Hour24:"",Minute:"",Second:"",Time:"",Time24:"",DateShort:"",DateLong:"",DateFull:"",Month:"",MonthNum:"",WeekNum:"",Day:"",DayNum:"",Year:"",ClientWidth:$window.innerWidth,ClientHeight:$window.innerHeight,WindowWidth:$window.outerWidth,WindowHeight:$window.outerHeight,Orientation:$scope.GetOrientation(),OperatingSystem:"",$Watches:{},$Timers:{},$Audio:{}};$scope.__doUpdate=function(){var Now=new Date();$App.NAB.Hour=$filter("date")(Now,"h");$App.NAB.Hour24=$filter("date")(Now,"H");$App.NAB.Minute=$filter("date")(Now,"mm");$App.NAB.Second=$filter("date")(Now,"ss");$App.NAB.Time=$filter("date")(Now,"mediumTime");$App.NAB.Time24=$filter("date")(Now,"H:mm:ss");$App.NAB.DateShort=$filter("date")(Now,"shortDate");$App.NAB.DateLong=$filter("date")(Now,"longDate");$App.NAB.DateFull=$filter("date")(Now,"fullDate");$App.NAB.Month=$filter("date")(Now,"MMMM");$App.NAB.MonthNum=$filter("date")(Now,"M");$App.NAB.WeekNum=$filter("date")(Now,"w");$App.NAB.Day=$filter("date")(Now,"EEEE");$App.NAB.DayNum=$filter("date")(Now,"d");$App.NAB.Year=$filter("date")(Now,"yyyy");};$scope.__doOrientationChange=function(){$App.NAB.Orientation=$scope.GetOrientation();};$scope.__doResize=function(){$App.NAB.ClientWidth=$window.innerWidth;$App.NAB.ClientHeight=$window.innerHeight;$App.NAB.WindowWidth=$window.outerWidth;$App.NAB.WindowHeight=$window.outerHeight;};$scope.__init=function(){angular.element($window).bind("orientationchange.app",function(){$timeout($scope.__doOrientationChange);});angular.element($window).bind("resize.app",function(){$timeout($scope.__doResize);});$interval($scope.__doUpdate,1000);$App.NAB.OperatingSystem=GetPlatform();$scope.__doUpdate();};
...
$App.Workdaytyperecordandnotes = localStorage.getItem("Workdaytyperecordandnotes");
$App.diff21 = localStorage.getItem("diff21");
$App.start1 = localStorage.getItem("start1");
$App.end1 = localStorage.getItem("end1");
$App.diff21 = dtDateDiff( $App.start1, $App.end1, "mm/dd/yyyy" );
$App.diff22 = localStorage.getItem("diff22");
$App.start2 = localStorage.getItem("start2");
$App.end2 = localStorage.getItem("end2");
$App.diff22 = dtDateDiff( $App.start2, $App.end2, "mm/dd/yyyy" );
$App.diff23 = localStorage.getItem("diff23");
$App.start3 = localStorage.getItem("start3");
$App.end3 = localStorage.getItem("end3");
$App.diff23 = dtDateDiff( $App.start3, $App.end3, "mm/dd/yyyy" );
...
$scope.Dictionary_pageexit = function() {localStorage.setItem("Random12b",$App.Random12b);};
...
$App.NAB.PageID = "Home";
$scope.Headline57_click = function() {$App.versiondetail = localStorage.getItem("versiondetail");
$App.versiondetailb = localStorage.getItem("versiondetailb");
$scope.GotoPage( "Versiondetail" );};
$scope.PushButton456_click = function() {$scope.GotoPage( "MainBoard" );};
$scope.PushButton459_click = function() {$scope.GotoPage( "Dailysheet" );
$App.June25healthdiary = localStorage.getItem("June25healthdiary");
...
$App.wain = $App.select;
$scope.GotoPage( "map" );};
$scope.Headline5_click = function() {$App.anid = localStorage.getItem("anid");
$App.aniy = localStorage.getItem("aniy");
$App.s1rd = localStorage.getItem("s1rd");
$App.s1rdd = localStorage.getItem("s1rdd");
$App.s2rd = localStorage.getItem("s2rd");
$App.s2rdd = localStorage.getItem("s2rdd");
$App.s3rd = localStorage.getItem("s3rd");
$App.s3rdd = localStorage.getItem("s3rdd");
$App.s4rd = localStorage.getItem("s4rd");
$App.s4rdd = localStorage.getItem("s4rdd");
...
$scope.GotoPage( "Rulz" );};
$scope.Headline374_click = function() {$scope.GotoPage( "WorkDayType001" );};
...
$scope.PushButton246_click = function() {$App.rds1 = localStorage.getItem("rds1");
$App.rds1cdd = localStorage.getItem("rds1cdd");
$App.rds2 = localStorage.getItem("rds2");
$App.rds2cdd = localStorage.getItem("rds2cdd");
$App.rds3 = localStorage.getItem("rds3");
$App.rds3cdd = localStorage.getItem("rds3cdd");
$App.rds4 = localStorage.getItem("rds4");
$App.rds4cdd = localStorage.getItem("rds4cdd");
$App.rds5 = localStorage.getItem("rds5");
$App.rds5cdd = localStorage.getItem("rds5cdd");
$App.rds6 = localStorage.getItem("rds6");
$App.rds6cdd = localStorage.getItem("rds6cdd");
$App.calc001notes = localStorage.getItem("calc001notes");
$App.calc001notestit = localStorage.getItem("calc001notestit");
$App.calc002notes = localStorage.getItem("calc002notes");
$App.calc002notestit = localStorage.getItem("calc002notestit");
$App.calc003notes = localStorage.getItem("calc003notes");
$App.calc003notestit = localStorage.getItem("calc003notestit");
$App.calc004notes = localStorage.getItem("calc004notes");
$App.calc004notestit = localStorage.getItem("calc004notestit");
$App.calc005notes = localStorage.getItem("calc005notes");
$App.calc005notestit = localStorage.getItem("calc005notestit");
$scope.GotoPage( "RetireMentPlanMain" );};
$scope.PushButton270_click = function() {$App.A0001 = localStorage.getItem("A0001");
$App.A0002 = localStorage.getItem("A0002");
$App.A0003 = localStorage.getItem("A0003");
$App.A0004 = localStorage.getItem("A0004");
$App.A0005 = localStorage.getItem("A0005");
$App.A0006 = localStorage.getItem("A0006");
$App.A0001a = localStorage.getItem("A0001a");
$App.A0001b = localStorage.getItem("A0001b");
$App.A0001c = localStorage.getItem("A0001c");
$App.A0001d = localStorage.getItem("A0001d");
$App.A0001X = localStorage.getItem("A0001X");
$scope.GotoPage( "Q0001" );};
$scope.PushButton272_click = function() {$App.A0001 = localStorage.getItem("A0001");
$App.A0002 = localStorage.getItem("A0002");
$App.A0003 = localStorage.getItem("A0003");
$App.A0004 = localStorage.getItem("A0004");
$App.A0005 = localStorage.getItem("A0005");
...
NeoApp.controller("Q0001_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 3;
$App.NAB.PageID = "Q0001";
$scope.PushButton269_click = function() {$scope.GotoPage( "Home" );};
$scope.Headline735_click = function() {$App.A0001an = "London";
if ($App.A0001an == "London") {
$App.A0001cr = "Correct answer Well Done";
$App.A0001sc = "1";
$App.A0001rs = "1";
} else {
$App.A0001cr = "Sorry incorrect, better luck next time";
};
$scope.ObjectToFront("A0001block");};
$scope.Headline734_click = function() {$App.A0001an = "Manchester";
if ($App.A0001an == "London") {
$App.A0001cr = "Correct answer Well Done";
$App.A0001sc = "1";
$App.A0001rs = "1";
...
$scope.ObjectToFront("A0001block");};
$scope.Headline736_click = function() {$App.A0001an = "Glasgow";
if ($App.A0001an == "London") {
$App.A0001cr = "Correct answer Well Done";
$App.A0001sc = "1";
$App.A0001rs = "1";
...
$scope.ObjectToFront("A0001block");};
$scope.Headline737_click = function() {$App.A0001an = "Birmingham";
if ($App.A0001an == "London") {
$App.A0001cr = "Correct answer Well Done";
$App.A0001sc = "1";
$App.A0001rs = "1";
...
$scope.ObjectToFront("A0001block");};
$scope.PushButton271_click = function() {$scope.ObjectToBack("A0001block");};
});
NeoApp.controller("WQ0001_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 4;
$App.NAB.PageID = "WQ0001";
$scope.PushButton274_click = function() {$scope.GotoPage( "Home" );};
$scope.Headline732_click = function() {$App.A0001an = "London";
if ($App.A0001an == "London") {
$App.A0001cr = "Correct answer Well Done";
$App.A0001sc = "1";
$App.A0001rs = "1";
...
$scope.ObjectToFront("A0001block");};
$scope.Headline733_click = function() {$App.A0001an = "Manchester";
if ($App.A0001an == "London") {
$App.A0001cr = "Correct answer Well Done";
$App.A0001sc = "1";
$App.A0001rs = "1";
...
$scope.ObjectToFront("A0001block");};
$scope.Headline738_click = function() {$App.A0001an = "Glasgow";
if ($App.A0001an == "London") {
$App.A0001cr = "Correct answer Well Done";
$App.A0001sc = "1";
$App.A0001rs = "1";
...
$scope.ObjectToFront("A0001block");};
$scope.Headline739_click = function() {$App.A0001an = "Birmingham";
if ($App.A0001an == "London") {
$App.A0001cr = "Correct answer Well Done";
$App.A0001sc = "1";
$App.A0001rs = "1";
...
$scope.ObjectToFront("A0001block");};
$scope.PushButton275_click = function() {$scope.ObjectToBack("A0001block");};
});
NeoApp.controller("KnowThyselfMoney_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 5;
$App.NAB.PageID = "KnowThyselfMoney";
...
$scope.PushButton264_click = function() {$scope.GotoPage( "Calc04" );};
$scope.PushButton265_click = function() {$scope.GotoPage( "Calc05" );};
$scope.Headline704_click = function() {$scope.GotoPage( "RetireMentPlanMainEdit" );};
});
NeoApp.controller("RetireMentPlanMainEdit_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 7;
$App.NAB.PageID = "RetireMentPlanMainEdit";
$scope.PushButton238_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea112_change = function() {localStorage.setItem("rds1",$App.rds1);};
$scope.TextArea157_change = function() {localStorage.setItem("diff21",$App.diff21);};
$scope.TextArea158_change = function() {localStorage.setItem("rds2",$App.rds2);};
$scope.TextArea161_change = function() {localStorage.setItem("rds3",$App.rds3);};
$scope.TextArea162_change = function() {localStorage.setItem("rds3cdd",$App.rds3cdd);};
$scope.TextArea163_change = function() {localStorage.setItem("rds4",$App.rds4);};
$scope.TextArea164_change = function() {localStorage.setItem("rds4cdd",$App.rds4cdd);};
$scope.TextArea165_change = function() {localStorage.setItem("rds5",$App.rds5);};
$scope.TextArea175_change = function() {localStorage.setItem("rds5cdd",$App.rds5cdd);};
$scope.TextArea176_change = function() {localStorage.setItem("rds6",$App.rds6);};
$scope.TextArea177_change = function() {localStorage.setItem("rds6cdd",$App.rds6cdd);};
$scope.PushButton245_click = function() {$scope.GotoPage( "RetireMentPlanMain" );};
$scope.PushButton247_click = function() {$scope.GotoPage( "RetireMentPlanMain" );};
$scope.PushButton248_click = function() {$scope.GotoPage( "RetireMentPlanMain" );};
$scope.PushButton249_click = function() {$scope.GotoPage( "RetireMentPlanMain" );};
$scope.PushButton250_click = function() {$scope.GotoPage( "RetireMentPlanMain" );};
$scope.PushButton251_click = function() {$scope.GotoPage( "RetireMentPlanMain" );};
$scope.TextInput5_change = function() {localStorage.setItem("end1",$App.end1);};
$scope.PushButton266_click = function() {$App.start1 = $App.NAB.DateShort;
$App.diff21 = dtDateDiff( $App.start1, $App.end1, "mm/dd/yyyy" );
localStorage.setItem("diff21",$App.diff21);
localStorage.setItem("start1",$App.start1);
localStorage.setItem("end1",$App.end1);};
$scope.TextInput7_change = function() {localStorage.setItem("end1",$App.end1);};
$scope.PushButton267_click = function() {$App.start2 = $App.NAB.DateShort;
$App.diff22 = dtDateDiff( $App.start2, $App.end2, "mm/dd/yyyy" );
localStorage.setItem("diff21",$App.diff22);
localStorage.setItem("start2",$App.start2);
localStorage.setItem("end2",$App.end2);};
$scope.TextInput10_change = function() {localStorage.setItem("end3",$App.end3);};
$scope.PushButton268_click = function() {$App.start2 = $App.NAB.DateShort;
$App.diff23 = dtDateDiff( $App.start3, $App.end2, "mm/dd/yyyy" );
localStorage.setItem("diff23",$App.diff23);
localStorage.setItem("start3",$App.start3);
localStorage.setItem("end3",$App.end3);};
});
NeoApp.controller("Calc01_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 8;
$App.NAB.PageID = "Calc01";
$scope.PushButton252_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton253_click = function() {$scope.GotoPage( "RetireMentPlanMain" );};
$scope.TextArea179_change = function() {localStorage.setItem("calc001notes",$App.calc001notes);};
$scope.TextArea178_change = function() {localStorage.setItem("calc001notestit",$App.calc001notestit);};
});
NeoApp.controller("Calc02_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 9;
$App.NAB.PageID = "Calc02";
$scope.PushButton254_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton255_click = function() {$scope.GotoPage( "RetireMentPlanMain" );};
$scope.TextArea180_change = function() {localStorage.setItem("calc002notes",$App.calc002notes);};
$scope.TextArea181_change = function() {localStorage.setItem("calc002notestit",$App.calc002notestit);};
});
NeoApp.controller("Calc03_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 10;
$App.NAB.PageID = "Calc03";
$scope.PushButton256_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton257_click = function() {$scope.GotoPage( "RetireMentPlanMain" );};
$scope.TextArea182_change = function() {localStorage.setItem("calc003notes",$App.calc003notes);};
$scope.TextArea183_change = function() {localStorage.setItem("calc003notestit",$App.calc003notestit);};
});
NeoApp.controller("Calc04_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 11;
$App.NAB.PageID = "Calc04";
$scope.PushButton258_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton259_click = function() {$scope.GotoPage( "RetireMentPlanMain" );};
$scope.TextArea184_change = function() {localStorage.setItem("calc004notes",$App.calc004notes);};
$scope.TextArea229_change = function() {localStorage.setItem("calc004notestit",$App.calc004notestit);};
});
NeoApp.controller("Calc05_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 12;
$App.NAB.PageID = "Calc05";
$scope.PushButton260_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton261_click = function() {$scope.GotoPage( "RetireMentPlanMain" );};
$scope.TextArea230_change = function() {localStorage.setItem("calc005notes",$App.calc005notes);};
$scope.TextArea231_change = function() {localStorage.setItem("calc005notestit",$App.calc005notestit);};
});
NeoApp.controller("CentralAdmin_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
...
NeoApp.controller("Mindmap_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 14;
$App.NAB.PageID = "Mindmap";
$scope.PushButton3_click = function() {$scope.GotoPage( "Home" );};
$scope.Headline155_click = function() {$App.startday = localStorage.getItem("startday");
$scope.GotoPage( "startday" );};
$scope.Headline156_click = function() {$App.wdiw = localStorage.getItem("wdiw");
$scope.GotoPage( "WDIW" );};
$scope.Headline157_click = function() {$App.disciplin = localStorage.getItem("disciplin");
$scope.GotoPage( "Disciplin" );};
$scope.Headline159_click = function() {$App.themeans = localStorage.getItem("themeans");
$scope.GotoPage( "TheMeans" );};
$scope.Headline160_click = function() {$App.centraladmin = localStorage.getItem("centraladmin");
$scope.GotoPage( "CentralAdmin" );};
$scope.Headline161_click = function() {$App.filter = localStorage.getItem("filter");
$App.filter001 = localStorage.getItem("filter001");
$App.filter002 = localStorage.getItem("filter002");
$App.filter003 = localStorage.getItem("filter003");
$App.filter004 = localStorage.getItem("filter004");
$App.filter005 = localStorage.getItem("filter005");
$App.filter006 = localStorage.getItem("filter006");
$App.filter007 = localStorage.getItem("filter007");
$App.filter008 = localStorage.getItem("filter008");
$App.filter009 = localStorage.getItem("filter009");
$App.filter010 = localStorage.getItem("filter010");
$App.filter011 = localStorage.getItem("filter011");
$App.filter012 = localStorage.getItem("filter012");
$App.filter013 = localStorage.getItem("filter013");
...
$scope.GotoPage( "FF" );};
$scope.Headline452_click = function() {$App.health = localStorage.getItem("health");
...
$App.NAB.PageID = "Disciplin";
$scope.PushButton224_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea101_change = function() {localStorage.setItem("disciplin",$App.disciplin);};
});
NeoApp.controller("Versiondetail_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 16;
$App.NAB.PageID = "Versiondetail";
$scope.PushButton236_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea110_change = function() {localStorage.setItem("versiondetail",$App.versiondetail);};
$scope.TextArea111_change = function() {localStorage.setItem("versiondetailb",$App.versiondetailb);};
});
NeoApp.controller("startday_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 17;
$App.NAB.PageID = "startday";
$scope.PushButton223_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea109_change = function() {localStorage.setItem("startday",$App.startday);};
});
NeoApp.controller("TheMeans_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 18;
$App.NAB.PageID = "TheMeans";
$scope.PushButton226_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea102_change = function() {localStorage.setItem("themeans",$App.themeans);};
});
...
$scope.TextArea169_change = function() {localStorage.setItem("filter004",$App.filter004);};
$scope.TextArea170_change = function() {localStorage.setItem("filter012",$App.filter012);};
$scope.TextArea171_change = function() {localStorage.setItem("filter013",$App.filter013);};
...
$scope.PushButton230_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea106_change = function() {localStorage.setItem("health",$App.health);};
});
NeoApp.controller("FF_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 21;
$App.NAB.PageID = "FF";
$scope.PushButton237_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea107_change = function() {localStorage.setItem("ff",$App.ff);};
});
NeoApp.controller("WDIW_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 22;
$App.NAB.PageID = "WDIW";
$scope.PushButton242_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea108_change = function() {localStorage.setItem("wdiw",$App.wdiw);};
});
NeoApp.controller("KnowTyMoInput01_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 23;
$App.NAB.PageID = "KnowTyMoInput01";
$scope.PushButton2_click = function() {$scope.GotoPage( "Home" );};
$scope.TextInput1_change = function() {localStorage.setItem("aniy",$App.aniy);};
$scope.TextInput2_change = function() {localStorage.setItem("s1rd",$App.s1rd);};
$scope.TextInput4_change = function() {localStorage.setItem("s2rd",$App.s2rd);};
$scope.TextInput6_change = function() {localStorage.setItem("s3rd",$App.s3rd);};
$scope.TextInput8_change = function() {localStorage.setItem("s4rd",$App.s4rd);};
$scope.TextArea86_change = function() {localStorage.setItem("s1rdd",$App.s1rdd);};
$scope.TextArea96_change = function() {localStorage.setItem("s2rdd",$App.s2rdd);};
$scope.TextArea97_change = function() {localStorage.setItem("s3rdd",$App.s3rdd);};
$scope.TextArea98_change = function() {localStorage.setItem("s4rdd",$App.s4rdd);};
$scope.TextArea99_change = function() {localStorage.setItem("s14notes",$App.s14notes);};
...
$scope.Headline250_click = function() {$scope.GotoPage( "WorkDayType001" );};
});
NeoApp.controller("WorkDayType001_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 26;
$App.NAB.PageID = "WorkDayType001";
$scope.Headline64_click = function() {$App.AZDictionary = localStorage.getItem("AZDictionary");
$scope.GotoPage( "Dictionary" );};
$scope.Headline51_click = function() {$scope.GotoPage( "Home" );};
$scope.Headline382_click = function() {$App.Workdaytyperecordandnotes = localStorage.getItem("Workdaytyperecordandnotes");
$scope.GotoPage( "Workdaytyperecordandnotes" );};
$scope.Headline54_click = function() {$App.WD01 = localStorage.getItem("WD01");
$App.WD02 = localStorage.getItem("WD02");
$App.WD03 = localStorage.getItem("WD03");
$App.WD04 = localStorage.getItem("WD04");
$App.WD05 = localStorage.getItem("WD05");
$App.WD06 = localStorage.getItem("WD06");
$App.WD07 = localStorage.getItem("WD07");
$App.WD08 = localStorage.getItem("WD08");
$scope.GotoPage( "Workday01" );};
$scope.Headline62_click = function() {$App.WD01 = localStorage.getItem("WD01");
$App.WD02 = localStorage.getItem("WD02");
$App.WD03 = localStorage.getItem("WD03");
$App.WD04 = localStorage.getItem("WD04");
$App.WD05 = localStorage.getItem("WD05");
...
$App.WD07 = localStorage.getItem("WD07");
$App.WD08 = localStorage.getItem("WD08");
$scope.GotoPage( "Workday06" );};
$scope.Headline313_click = function() {$App.WD01 = localStorage.getItem("WD01");
$App.WD02 = localStorage.getItem("WD02");
$App.WD03 = localStorage.getItem("WD03");
$App.WD04 = localStorage.getItem("WD04");
$App.WD05 = localStorage.getItem("WD05");
...
$App.WD07 = localStorage.getItem("WD07");
$App.WD08 = localStorage.getItem("WD08");
$scope.GotoPage( "Workday07" );};
$scope.Headline315_click = function() {$App.WD01 = localStorage.getItem("WD01");
$App.WD02 = localStorage.getItem("WD02");
$App.WD03 = localStorage.getItem("WD03");
$App.WD04 = localStorage.getItem("WD04");
$App.WD05 = localStorage.getItem("WD05");
...
$App.WD07 = localStorage.getItem("WD07");
$App.WD08 = localStorage.getItem("WD08");
$scope.GotoPage( "Workday08" );};
$scope.Headline52_click = function() {$App.WD01 = localStorage.getItem("WD01");
$App.WD02 = localStorage.getItem("WD02");
$App.WD03 = localStorage.getItem("WD03");
$App.WD04 = localStorage.getItem("WD04");
$App.WD05 = localStorage.getItem("WD05");
...
$App.WD07 = localStorage.getItem("WD07");
$App.WD08 = localStorage.getItem("WD08");
$scope.GotoPage( "Workday02" );};
$scope.Headline58_click = function() {$App.WD01 = localStorage.getItem("WD01");
$App.WD02 = localStorage.getItem("WD02");
$App.WD03 = localStorage.getItem("WD03");
$App.WD04 = localStorage.getItem("WD04");
$App.WD05 = localStorage.getItem("WD05");
...
$App.WD07 = localStorage.getItem("WD07");
$App.WD08 = localStorage.getItem("WD08");
$scope.GotoPage( "Workday03" );};
$scope.Headline59_click = function() {$App.WD01 = localStorage.getItem("WD01");
$App.WD02 = localStorage.getItem("WD02");
$App.WD03 = localStorage.getItem("WD03");
$App.WD04 = localStorage.getItem("WD04");
$App.WD05 = localStorage.getItem("WD05");
...
$App.WD07 = localStorage.getItem("WD07");
$App.WD08 = localStorage.getItem("WD08");
$scope.GotoPage( "Workday04" );};
$scope.Headline310_click = function() {$App.WD01 = localStorage.getItem("WD01");
$App.WD02 = localStorage.getItem("WD02");
$App.WD03 = localStorage.getItem("WD03");
$App.WD04 = localStorage.getItem("WD04");
$App.WD05 = localStorage.getItem("WD05");
...
$scope.Headline338_click = function() {$scope.GotoPage( "Home" );};
});
...
$scope.Headline330_click = function() {$scope.GotoPage( "Home" );};
});
NeoApp.controller("Workday03_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
...
$scope.Headline337_click = function() {$scope.GotoPage( "Home" );};
});
...
$scope.Headline345_click = function() {$scope.GotoPage( "Home" );};
});
...
$scope.Headline352_click = function() {$scope.GotoPage( "Home" );};
});
...
$scope.Headline359_click = function() {$scope.GotoPage( "Home" );};
});
...
$scope.Headline366_click = function() {$scope.GotoPage( "Home" );};
});
...
$scope.Headline373_click = function() {$scope.GotoPage( "Home" );};
});
...
$scope.Headline381_click = function() {$scope.GotoPage( "Home" );};
});
...
$scope.TextArea152_change = function() {localStorage.setItem("June25ADHDdiary",$App.June25ADHDdiary);};
$scope.TextArea153_change = function() {localStorage.setItem("June25Pohdiary",$App.June25Pohdiary);};
$scope.TextArea154_change = function() {localStorage.setItem("June25healthdiary",$App.June25healthdiary);};
...
$scope.TextArea142_change = function() {localStorage.setItem("AZDictionary",$App.AZDictionary);};
