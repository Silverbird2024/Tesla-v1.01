...
$scope.PushButton224_click = function() {$App.FPA002 = localStorage.getItem("FPA002");
$App.FPA002m = localStorage.getItem("FPA002m");
$scope.GotoPage( "FPA002" );};
});
