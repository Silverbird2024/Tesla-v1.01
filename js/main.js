...
$App.NAB={PageList:["Home","Home2","FampleADHDA","FPA001","FPA002","FPA003","FPA004","FPA005","FPA006","FPA007","FPA008","FPA009","FPA010","KnowThyselfMoney","KnowTyMoInput01","Work01","RulesMatter","WorkDayType001","Workday01","Workday02","Workday03","Workday04","Workday05","Workday06","Workday07","Workday08","Workdaytyperecordandnotes","ADHDhelper","Time-Pa","Rulz","WorkDoNotEnjoy01","WorkDoNotEnjoy02","WorkDoNotEnjoy03","WorkDoNotEnjoy04","WorkDoNotEnjoy05","WorkDoNotEnjoy06","WorkDoNotEnjoy07","WorkDoNotEnjoy08","WorkCWD-adjust","Dailysheet","adh00","adh01","adh02","adh03","adh04","adh05","adh06","adh07","adh08","adh09","adh10","adh11","adh12","adh13","adh14","adh15","adh16","RanMain","Dreamboard","Dreamboard01","Dreamboard02","Dreamboard03","Dreamboard04","Dreamboard05","Dreamboard06","Dreamboard07","Dreamboard08","Dreamboard09","Dreamboard10","Dreamboard11","Dreamboard12","Dreamboard13","Dreamboard14","Dreamboard15","Dreamboard16","Dreamboard17","Dreamboard18","Dreamboard19","Dreamboard20","Dreamboard21","Permanace","Page02","Milesrecorder","map","Random","Random01","Random02","Random03","Random04","Random05","Random06","Random07","Random08","Random09","Random10","Random11","Random12","Random13","Random14","Random15","Random16","Random17","Random18","Random19","Random20","Random21","Random22","Random23","Random24","Random25","Dictionary"],PageEnterEffect:["fadeIn","fadeIn","","","","","","","","","","","","fadeIn","fadeIn","","","","","","","","","","","","","","","","","","","","","","","","","","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn"],PageCount:111,_pageEffect:" animate fadeIn",PageExitEffect:["","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""],PageNumber:1,AppScale:1,PageID:"",Hour:"",Hour24:"",Minute:"",Second:"",Time:"",Time24:"",DateShort:"",DateLong:"",DateFull:"",Month:"",MonthNum:"",WeekNum:"",Day:"",DayNum:"",Year:"",ClientWidth:$window.innerWidth,ClientHeight:$window.innerHeight,WindowWidth:$window.outerWidth,WindowHeight:$window.outerHeight,Orientation:$scope.GetOrientation(),OperatingSystem:"",$Watches:{},$Timers:{},$Audio:{}};$scope.__doUpdate=function(){var Now=new Date();$App.NAB.Hour=$filter("date")(Now,"h");$App.NAB.Hour24=$filter("date")(Now,"H");$App.NAB.Minute=$filter("date")(Now,"mm");$App.NAB.Second=$filter("date")(Now,"ss");$App.NAB.Time=$filter("date")(Now,"mediumTime");$App.NAB.Time24=$filter("date")(Now,"H:mm:ss");$App.NAB.DateShort=$filter("date")(Now,"shortDate");$App.NAB.DateLong=$filter("date")(Now,"longDate");$App.NAB.DateFull=$filter("date")(Now,"fullDate");$App.NAB.Month=$filter("date")(Now,"MMMM");$App.NAB.MonthNum=$filter("date")(Now,"M");$App.NAB.WeekNum=$filter("date")(Now,"w");$App.NAB.Day=$filter("date")(Now,"EEEE");$App.NAB.DayNum=$filter("date")(Now,"d");$App.NAB.Year=$filter("date")(Now,"yyyy");};$scope.__doOrientationChange=function(){$App.NAB.Orientation=$scope.GetOrientation();};$scope.__doResize=function(){$App.NAB.ClientWidth=$window.innerWidth;$App.NAB.ClientHeight=$window.innerHeight;$App.NAB.WindowWidth=$window.outerWidth;$App.NAB.WindowHeight=$window.outerHeight;};$scope.__init=function(){angular.element($window).bind("orientationchange.app",function(){$timeout($scope.__doOrientationChange);});angular.element($window).bind("resize.app",function(){$timeout($scope.__doResize);});$interval($scope.__doUpdate,1000);$App.NAB.OperatingSystem=GetPlatform();$scope.__doUpdate();};
...
$scope.PushButton3_click = function() {$App.adhdforname = localStorage.getItem("adhdforname");
$scope.GotoPage( "FampleADHDA" );};
});
...
NeoApp.controller("FampleADHDA_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 3;
$App.NAB.PageID = "FampleADHDA";
$scope.Headline157_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
$scope.TextArea100_change = function() {localStorage.setItem("adhdforname",$App.adhdforname);};
$scope.Headline161_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton196_click = function() {$App.FPA001 = localStorage.getItem("FPA001");
$App.FPA001m = localStorage.getItem("FPA001m");
$scope.GotoPage( "FPA001" );};
$scope.PushButton197_click = function() {$App.FPA002 = localStorage.getItem("FPA002");
$App.FPA002m = localStorage.getItem("FPA002m");
$scope.GotoPage( "FPA002" );};
$scope.PushButton224_click = function() {$App.FPA003 = localStorage.getItem("FPA003");
$App.FPA003m = localStorage.getItem("FPA003m");
$scope.GotoPage( "FPA003" );};
$scope.PushButton227_click = function() {$App.FPA004 = localStorage.getItem("FPA004");
$App.FPA004m = localStorage.getItem("FPA004m");
$scope.GotoPage( "FPA004" );};
$scope.PushButton229_click = function() {$App.FPA005 = localStorage.getItem("FPA005");
$App.FPA005m = localStorage.getItem("FPA005m");
$scope.GotoPage( "FPA005" );};
$scope.PushButton237_click = function() {$App.FPA006 = localStorage.getItem("FPA006");
$App.FPA006m = localStorage.getItem("FPA006m");
$scope.GotoPage( "FPA006" );};
$scope.PushButton243_click = function() {$App.FPA007 = localStorage.getItem("FPA007");
$App.FPA007m = localStorage.getItem("FPA007m");
$scope.GotoPage( "FPA007" );};
$scope.PushButton245_click = function() {$App.FPA008 = localStorage.getItem("FPA008");
$App.FPA008m = localStorage.getItem("FPA008m");
$scope.GotoPage( "FPA008" );};
$scope.PushButton246_click = function() {$App.FPA009 = localStorage.getItem("FPA009");
$App.FPA009m = localStorage.getItem("FPA009m");
$scope.GotoPage( "FPA009" );};
$scope.PushButton248_click = function() {$App.FPA010 = localStorage.getItem("FPA010");
$App.FPA010m = localStorage.getItem("FPA010m");
$scope.GotoPage( "FPA010" );};
});
NeoApp.controller("FPA001_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 4;
$App.NAB.PageID = "FPA001";
$scope.Headline452_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
$scope.TextArea101_change = function() {localStorage.setItem("FPA001",$App.FPA001);};
$scope.Headline463_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton223_click = function() {$scope.GotoPage( "FampleADHDA" );};
$scope.TextArea102_change = function() {localStorage.setItem("FPA001m",$App.FPA001m);};
$scope.Headline633_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
});
NeoApp.controller("FPA002_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 5;
$App.NAB.PageID = "FPA002";
$scope.Headline643_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
$scope.TextArea106_change = function() {localStorage.setItem("FPA002",$App.FPA002);};
$scope.Headline644_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton226_click = function() {$scope.GotoPage( "FampleADHDA" );};
$scope.TextArea107_change = function() {localStorage.setItem("FPA002m",$App.FPA002m);};
$scope.Headline645_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
});
NeoApp.controller("FPA003_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 6;
$App.NAB.PageID = "FPA003";
$scope.Headline637_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
$scope.TextArea104_change = function() {localStorage.setItem("FPA003",$App.FPA003);};
$scope.Headline638_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton225_click = function() {$scope.GotoPage( "FampleADHDA" );};
$scope.FPA001M_change = function() {localStorage.setItem("FPA003m",$App.FPA003m);};
$scope.Headline639_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
});
NeoApp.controller("FPA004_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 7;
$App.NAB.PageID = "FPA004";
$scope.Headline649_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
$scope.TextArea108_change = function() {localStorage.setItem("FPA004",$App.FPA004);};
$scope.Headline650_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton228_click = function() {$scope.GotoPage( "FampleADHDA" );};
$scope.TextArea109_change = function() {localStorage.setItem("FPA004m",$App.FPA003m);};
$scope.Headline651_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
});
NeoApp.controller("FPA005_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 8;
$App.NAB.PageID = "FPA005";
$scope.Headline655_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
$scope.TextArea110_change = function() {localStorage.setItem("FPA005",$App.FPA005);};
$scope.Headline656_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton230_click = function() {$scope.GotoPage( "FampleADHDA" );};
$scope.TextArea111_change = function() {localStorage.setItem("FPA005m",$App.FPA005m);};
$scope.Headline657_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
});
NeoApp.controller("FPA006_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 9;
$App.NAB.PageID = "FPA006";
$scope.Headline661_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
$scope.TextArea112_change = function() {localStorage.setItem("FPA006",$App.FPA006);};
$scope.Headline662_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton236_click = function() {$scope.GotoPage( "FampleADHDA" );};
$scope.TextArea157_change = function() {localStorage.setItem("FPA006m",$App.FPA006m);};
$scope.Headline663_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
});
NeoApp.controller("FPA007_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 10;
$App.NAB.PageID = "FPA007";
$scope.Headline667_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
$scope.TextArea158_change = function() {localStorage.setItem("FPA007",$App.FPA007);};
$scope.Headline668_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton238_click = function() {$scope.GotoPage( "FampleADHDA" );};
$scope.TextArea159_change = function() {localStorage.setItem("FPA007m",$App.FPA007m);};
$scope.Headline669_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
});
NeoApp.controller("FPA008_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 11;
$App.NAB.PageID = "FPA008";
$scope.Headline673_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
$scope.TextArea160_change = function() {localStorage.setItem("FPA008",$App.FPA008);};
$scope.Headline674_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton242_click = function() {$scope.GotoPage( "FampleADHDA" );};
$scope.TextArea161_change = function() {localStorage.setItem("FPA008m",$App.FPA008m);};
$scope.Headline675_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
});
NeoApp.controller("FPA009_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 12;
$App.NAB.PageID = "FPA009";
$scope.Headline679_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
$scope.TextArea162_change = function() {localStorage.setItem("FPA009",$App.FPA009);};
$scope.Headline680_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton247_click = function() {$scope.GotoPage( "FampleADHDA" );};
$scope.TextArea163_change = function() {localStorage.setItem("FPA009m",$App.FPA0009m);};
$scope.Headline681_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
});
NeoApp.controller("FPA010_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 13;
$App.NAB.PageID = "FPA010";
$scope.Headline685_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
$scope.TextArea164_change = function() {localStorage.setItem("FPA010",$App.FPA010);};
$scope.Headline686_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton249_click = function() {$scope.GotoPage( "FampleADHDA" );};
$scope.TextArea165_change = function() {localStorage.setItem("FPA010m",$App.FPA010m);};
$scope.Headline687_click = function() {$scope.GotoPage( "WorkDoNotEnjoy01" );};
});
