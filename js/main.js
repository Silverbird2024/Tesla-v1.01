...
$App.NAB={PageList:["Home","Dailysheet","May25","adh00","adh01","adh02","adh03","adh04","adh05","adh06","adh07","adh08","adh09","adh10","adh11","adh12","Debtclock","RanMain","Dreamboard","Dreamboard01","Dreamboard02","Dreamboard03","Dreamboard04","Dreamboard05","Dreamboard06","Dreamboard07","Dreamboard08","Dreamboard09","Dreamboard10","Dreamboard11","Dreamboard12","Dreamboard13","Dreamboard14","Dreamboard15","Dreamboard16","Dreamboard17","Dreamboard18","Dreamboard19","Dreamboard20","Dreamboard21","Debtclockinput","Permanace","Page02","Milesrecorder","map","Random","Random01","Random02","Random03","Random04","Random05","Random06","Random07","Random08","Random09","Random10","Random11","Random12","Random13","Random14","Random15","Random16","Random17","Random18","Random19","Random20","Random21","Random22","Random23","Random24","Random25"],PageEnterEffect:["fadeIn","","","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn","fadeIn"],PageCount:71,_pageEffect:" animate fadeIn",PageExitEffect:["","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""],PageNumber:1,AppScale:1,PageID:"",Hour:"",Hour24:"",Minute:"",Second:"",Time:"",Time24:"",DateShort:"",DateLong:"",DateFull:"",Month:"",MonthNum:"",WeekNum:"",Day:"",DayNum:"",Year:"",ClientWidth:$window.innerWidth,ClientHeight:$window.innerHeight,WindowWidth:$window.outerWidth,WindowHeight:$window.outerHeight,Orientation:$scope.GetOrientation(),OperatingSystem:"",$Watches:{},$Timers:{},$Audio:{}};$scope.__doUpdate=function(){var Now=new Date();$App.NAB.Hour=$filter("date")(Now,"h");$App.NAB.Hour24=$filter("date")(Now,"H");$App.NAB.Minute=$filter("date")(Now,"mm");$App.NAB.Second=$filter("date")(Now,"ss");$App.NAB.Time=$filter("date")(Now,"mediumTime");$App.NAB.Time24=$filter("date")(Now,"H:mm:ss");$App.NAB.DateShort=$filter("date")(Now,"shortDate");$App.NAB.DateLong=$filter("date")(Now,"longDate");$App.NAB.DateFull=$filter("date")(Now,"fullDate");$App.NAB.Month=$filter("date")(Now,"MMMM");$App.NAB.MonthNum=$filter("date")(Now,"M");$App.NAB.WeekNum=$filter("date")(Now,"w");$App.NAB.Day=$filter("date")(Now,"EEEE");$App.NAB.DayNum=$filter("date")(Now,"d");$App.NAB.Year=$filter("date")(Now,"yyyy");};$scope.__doOrientationChange=function(){$App.NAB.Orientation=$scope.GetOrientation();};$scope.__doResize=function(){$App.NAB.ClientWidth=$window.innerWidth;$App.NAB.ClientHeight=$window.innerHeight;$App.NAB.WindowWidth=$window.outerWidth;$App.NAB.WindowHeight=$window.outerHeight;};$scope.__init=function(){angular.element($window).bind("orientationchange.app",function(){$timeout($scope.__doOrientationChange);});angular.element($window).bind("resize.app",function(){$timeout($scope.__doResize);});$interval($scope.__doUpdate,1000);$App.NAB.OperatingSystem=GetPlatform();$scope.__doUpdate();};
...
$scope.Headline32_click = function() {$scope.GotoPage( "Dreamboard01" );};
$scope.Headline33_click = function() {$scope.GotoPage( "Dreamboard02" );};
$scope.Headline42_click = function() {$scope.GotoPage( "Dreamboard03" );};
$scope.Headline43_click = function() {$scope.GotoPage( "Dreamboard04" );};
$scope.Headline44_click = function() {$scope.GotoPage( "Dreamboard05" );};
$scope.Headline45_click = function() {$scope.GotoPage( "Dreamboard06" );};
$scope.Headline46_click = function() {$scope.GotoPage( "Dreamboard07" );};
$scope.Headline47_click = function() {$scope.GotoPage( "Dreamboard08" );};
$scope.Headline48_click = function() {$scope.GotoPage( "Dreamboard09" );};
$scope.Headline49_click = function() {$scope.GotoPage( "Dreamboard10" );};
$scope.Headline50_click = function() {$scope.GotoPage( "Dreamboard11" );};
$scope.Headline51_click = function() {$scope.GotoPage( "Dreamboard12" );};
$scope.Headline52_click = function() {$scope.GotoPage( "Dreamboard13" );};
$scope.Headline53_click = function() {$scope.GotoPage( "Dreamboard14" );};
$scope.Headline54_click = function() {$scope.GotoPage( "Dreamboard15" );};
$scope.Headline55_click = function() {$scope.GotoPage( "Dreamboard16" );};
$scope.Headline56_click = function() {$scope.GotoPage( "Dreamboard17" );};
$scope.Headline58_click = function() {$scope.GotoPage( "Dreamboard18" );};
$scope.Headline59_click = function() {$scope.GotoPage( "Dreamboard19" );};
$scope.Headline60_click = function() {$scope.GotoPage( "Dreamboard20" );};
$scope.Headline61_click = function() {$scope.GotoPage( "Dreamboard21" );};
$scope.Headline62_click = function() {$scope.GotoPage( "Dreamboard22" );};
$scope.Headline63_click = function() {$scope.GotoPage( "Dreamboard23" );};
$scope.Headline64_click = function() {$scope.GotoPage( "Dreamboard24" );};
...
NeoApp.controller("May25_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 3;
$App.NAB.PageID = "May25";
$scope.PushButton190_click = function() {neoTalkCancelSpeech();};
$scope.PushButton191_click = function() {neoTalkSpeak($App.feb25week1a, "uk", 1, .9);};
$scope.TextArea79_change = function() {localStorage.setItem("DS01",$App.ds01);};
$scope.TextArea80_change = function() {localStorage.setItem("DS02","DS02");};
$scope.TextArea81_change = function() {localStorage.setItem("DS03","DS03");};
$scope.TextArea82_change = function() {localStorage.setItem("Thisweek",$App.Thisweek);};
$scope.PushButton192_click = function() {$App.r11ts = $scope.Calculate($App.r11ts+"-1",-1);
$scope.SetObjectStyle("DS1S","font-size",$App.r11ts+"pt");};
$scope.PushButton193_click = function() {$App.r11ts = $scope.Calculate($App.r11ts+"+1",-1);
$scope.SetObjectStyle("DS1S","font-size",$App.r11ts+"pt");};
$scope.Image52_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea83_change = function() {localStorage.setItem("DS04",$App.ds04);};
$scope.PushButton194_click = function() {$App.r41ts = $scope.Calculate($App.r41ts+"-1",-1);
$scope.SetObjectStyle("DS4S","font-size",$App.r41ts+"pt");};
$scope.PushButton195_click = function() {$App.r41ts = $scope.Calculate($App.r41ts+"+1",-1);
$scope.SetObjectStyle("DS4S","font-size",$App.r41ts+"pt");};
});
...
$scope.PushButton170_click = function() {localStorage.setItem("ad12",$App.ad12);
localStorage.setItem("ad12b",$App.ad12b);
$scope.GotoPage( "Home" );};
$scope.PushButton171_click = function() {neoTalkPauseSpeech();
$scope.ObjectToBack("PushButton208");};
$scope.TextArea75_change = function() {localStorage.setItem("ad12b",$App.ad12b);};
$scope.PushButton173_click = function() {neoTalkSpeak($App.ad12b, "uk", 1, .9);};
$scope.PushButton175_click = function() {neoTalkCancelSpeech();};
$scope.TextArea76_change = function() {localStorage.setItem("ad12",$App.ad12);};
