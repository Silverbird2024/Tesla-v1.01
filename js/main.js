...
$App.etltd = localStorage.getItem("etltd");
...
$scope.TextInput1_change = function() {localStorage.setItem("anid",$App.anid);};
$scope.TextInput2_change = function() {localStorage.setItem("etltd",$App.etltd);};
$scope.PushButton236_click = function() {$App.etltdl = $scope.Calculate($App.anid+"+"+$App.etltd,-1);
$App.etltdlpc = $scope.Calculate($App.etltdl+"/100",-1);
$App.etltdlpc1 = $scope.Calculate($App.etltdl+"*87",-1);};
});
